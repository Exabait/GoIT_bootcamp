...
// const sortBy = (cars, callback) => {
//   const copyCars = [...cars].sort(callback);
//
//   return copyCars;
// };
//
// const ascSortByModel = (a, b) => a.model.localeCompare(b.model);
// const descSortByModel = (a, b) => b.model.localeCompare(a.model);
//
// console.table(sortBy(cars, ascSortByModel));
// console.table(sortBy(cars, ascSortByModel));
